/**
 * The kui-gantt brand mark, as raw geometry.
 *
...
export const COLORS = {
  ...
  /** CRITICAL PATH — the critical path — the one thing a reader scans a Gantt chart for. */
  toneTwo: "#ef4444",
...
export const WORDMARK = { lead: "kui", trail: " gantt" };
...
export const TAGLINE = "Dependency-aware Gantt charts for the web";
